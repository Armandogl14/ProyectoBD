		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			panel.setLayout(new BorderLayout(0, 0));
			{
				...
				panel.add(scrollPane, BorderLayout.CENTER);
				{
					...
					String[] columnas = { "Codigo", "Cedula", "Nivel_Educativo", "Contrato", "Mobilidad", "Licencia", "Sueldo","id_carrera","id_area","id_idioma","id_ciudad","activa"};
					...
					public void actionPerformed(ActionEvent e)
					{
						...
						if (selected != null)
						{
							...
							if (option == JOptionPane.OK_OPTION)
							{
								try
								{
									String borrar = "Delete from Solicitud_Persona" + " where Codigo = " + Integer.parseInt(selected.getCodigo());
